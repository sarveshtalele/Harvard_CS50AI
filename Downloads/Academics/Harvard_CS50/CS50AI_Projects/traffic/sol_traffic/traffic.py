...
def load_data(data_dir):
    ...
    # Iterate over each category directory (0 through NUM_CATEGORIES-1)
    for category in range(NUM_CATEGORIES):
        ...
        for filename in os.listdir(category_dir):
            ...
            # Read image and resize it to the target dimensions
...
def get_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        # A second convolutional layer with more filters
